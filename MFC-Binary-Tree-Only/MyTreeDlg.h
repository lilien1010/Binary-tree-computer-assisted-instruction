...
public:
	...
	//对树的节点坐标在dir方向上变动dis个像素;
	void ModifyNodeCoord(TreeNode * Tree,int dir,int dis);
	...
	/*在树中查找元素*/
	TreeNode * FindNode(TreeNode * Tree , char ch,int (CMyTreeDlg::*func)(TreeNode * Tree) );
	/*计算树的叶子节点*/
	...
	*/
	...
	int (CMyTreeDlg::*m_pfLegalFinder)(TreeNode * Tree);
...
protected:
	...
	afx_msg void OnButtonIdentityLeaf();
	DECLARE_MESSAGE_MAP()
};
